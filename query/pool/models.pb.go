...
type StableswapPool struct {
	...
	TotalShares *balance.Coin `protobuf:"bytes,5,opt,name=total_shares,json=totalShares,proto3" json:"total_shares,omitempty"`
	// assets in the pool
	PoolLiquidity *balance.Coin `protobuf:"bytes,6,opt,name=pool_liquidity,json=poolLiquidity,proto3" json:"pool_liquidity,omitempty"`
...
var file_proto_pool_models_proto_rawDesc = []byte{
	...
	0x69, 0x71, 0x75, 0x69, 0x64, 0x69, 0x74, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0d,
